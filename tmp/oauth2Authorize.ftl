...
[#macro main title="Login" rowClass="euiFlexGroup euiFlexGroup--alignItemsCenter euiFlexGroup--directionRow euiFlexGroup--justifyContentCenter" colClass="euiFlexItem euiFlexItem--flexGrowZero"]
<main class="euiPageBody">
  [@printErrorAlerts rowClass colClass/]
  [@printInfoAlerts rowClass colClass/]
  <div class="${rowClass}">
    <div class="${colClass}">
      <div class="euiPanel euiPanel--hasShadow euiPanel--paddingLarge" data-in-progress>
