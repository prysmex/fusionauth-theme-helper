...
[@helpers.html]
  ...
  [@helpers.body]
    ...
    [@helpers.accountMain rowClass="" colClass="" actionURL="" actionText=theme.message("go-back")]
      [@helpers.accountPanel title=theme.message("change-password") tenant=tenant user=currentUser action="edit" showEdit=true]
